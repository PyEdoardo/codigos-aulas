...
while True:
    ...
    if opcao == 6:
        ...
        print(f'{funcoes.procLogin(proc_user, usuarios)}')

    elif opcao == 3:
        dataProc = input("Qual a data a ser pesquisada: ")
        print(f'{funcoes.procData(dataProc, usuarios)}')
        ...
        if oqModificar == 'nome':
            ...
            funcoes.modificarNome(loginModificado, novoNome, usuarios)
            ...
            funcoes.modificarData(login=loginModificado, novaData=novoAcesso, usuarios=usuarios)
            ...
            funcoes.modificarID(loginModificado, novoId, usuarios)
        ...
        usuarioAapagar = input('Qual o usuário a ser apagado: ')
        funcoes.apagarUsuario(usuarioAapagar, usuarios)